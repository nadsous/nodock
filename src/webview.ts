...
<script nonce="${nonce}">
  ...
  const KIND_LABEL = { audit:'🔍 Audit de posture', websec:'🕸 Vulnérabilités applicatives', infra:'🐳 Conteneurs & CI/CD', dependency:'📦 Dépendances', secret:'🔑 Secrets', sast:'🐛 Code (SAST)', attack:'🥷 Vecteurs d\\'attaque', standards:'📐 Normes de codage', rgpd:'⚖️ Conformité mondiale & Mentions légales' };
